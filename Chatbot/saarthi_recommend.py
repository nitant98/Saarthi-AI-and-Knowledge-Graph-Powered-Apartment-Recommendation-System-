...
# from get_similar_groups import hobby
...
def display_recommend(graph_data,hobby):
    ...
    if not query_results:
        st.write("We don't have any apartments in your specified budget and requirement")
    else:


        # ----------------------------------->
        # user_text = 'string containing hobby'

        meetup_results = get_groups_for_user(hobby)
